...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="container-fluid">
      <table class="tg">
        <tr>
          <td class="tg-htd1"><?php echo $facturaActual->emisorRazonSocial; ?></td>
          <td class="tg-htd1"></td>
          <td class="tg-htd1"><?php echo $facturaActual->folioInterno; ?></td>
        </tr>
        <tr>
          <td class="tg-yqpd"><?php echo $facturaActual->emisorRfc; ?></td>
          <td class="tg-yqpd"></td>
          <td class="tg-yqpd">Folio Fiscal</td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="tg-yqpd">Fecha de Emisión</td>
          <td class="tg-yqpd"></td>
          <td class="tg-yqpd">Certificado del Sat</td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="tg-jax5" colspan="3">Datos de Receptor</td>
        </tr>
        <tr>
          <td class="tg-zv4m"><?php echo $facturaActual->receptorRazonSocial; ?></td>
          <td class="tg-zv4m"></td>
          <td class="tg-zv4m"><?php echo $facturaActual->receptorRfc; ?></td>
        </tr>
      </table>
    </div>
  </body>
